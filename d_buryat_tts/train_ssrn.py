...
from models import SSRN, weight_init
...
parser.add_argument('-s', '--save', dest='save_dir', required=False, default='ssrn_checkpoints', help='Where to save checkpoints')
parser.add_argument('-l', '--log', dest='log_dir', required=False, default='ssrn_logs', help='Where to save logs')
...
if __name__ == "__main__":
    ...
    dataset = TTSDataset(args.text_path, args.mel_path, args.lin_path)
    ...
    while True:
        for i, sample in enumerate(data_loader):
            ...
            if global_step % args.print_iter == 0:
                print("Epoch {}, Step {}, L1={:.4f}, BD={:.4f}, Total={:.4f}".format(epoch, global_step, l1_loss, bd_loss, loss))
